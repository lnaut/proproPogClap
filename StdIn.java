...
public final class StdIn {
   ...
   /**
    * Redirects System.in to read from a file instead of standard input.
    * @param filename Filename of the input file.
    */
    public static void setStdInToFile(String filename) {
        try {
    ...
    * @param filename Filename of the input file.
    */
    public static void setStdInToFile(File file) {
        try {
   ...
   /**
    * Redirects System.in to read from a file instead of standard input.
    * The file is chosen by means of a JFileChooser.
    */
    public static void setStdInToFile() {
        JFileChooser chooser = new JFileChooser();
        int choice = chooser.showOpenDialog(null);
        
        if (choice == JFileChooser.APPROVE_OPTION) { // Has the user clicked on "Open"?
            setStdInToFile(chooser.getSelectedFile());
        }        
	}
	
   /**
    * Redirects System.in back to the standard input.
    */
